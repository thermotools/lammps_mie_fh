...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(mie_fh2/cut,PairMIECutFH2);
// clang-format on
#else

#ifndef LMP_PAIR_MIE_CUT_FH2
#define LMP_PAIR_MIE_CUT_FH2

#include "pair.h"

namespace LAMMPS_NS {

  class PairMIECutFH2 : public Pair {
  public:
    PairMIECutFH2(class LAMMPS *);
    ~PairMIECutFH2() override;
